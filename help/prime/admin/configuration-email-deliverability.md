...
[!DNL Adobe Journey Optimizer B2B Edition] Primeは、最新のエンタープライズ向けメール作成および配信エクスペリエンスをB2B マーケターにもたらします。 このリリースでは、再設計された電子メールデザインツールと、包括的な電子メール配信品質コントロールが導入されます。
...
* **メール送信アクション** - ジャーニーから、プロファイル属性を使用したパーソナライゼーション（Handlebars構文）を含むメール送信アクションを追加します。
...
電子メールを設定する前に、製品全体の電子メールチャネル機能に適用される概念を確認します。
...
ジャーニー内で、**メールを送信** アクションには`manage-b2b-person-journeys`が必要です（アクションを追加し、ジャーニーをアクティブ化するには）。 メール権限のみを持つユーザーは、コンテンツの作成は可能ですが、ジャーニーにメールを追加することはできません。
