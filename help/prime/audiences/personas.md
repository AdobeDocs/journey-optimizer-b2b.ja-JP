...
* _セールスクオリファイアのコンテキスト_ - ビジネス開発担当者（BDR）には、個人のID、興味、バイヤージャーニーの現在の段階を示す1画面の概要が表示されます
...
[!DNL Journey Optimizer B2B Prime]は、定義されたペルソナに対してレコード属性を評価することにより、各個人レコードのペルソナを導き出します。 推測結果（_派生ペルソナ_）は、人物リストのオーディエンスを定義する場合や、人物ジャーニーのセグメント化に使用する場合のフィルターとして使用できます。
