...
Journey Optimizer B2B Primeでは、レコードの属性と定義されたペルソナを比較することで、各個人レコードのペルソナを導き出します。 推測結果（_派生ペルソナ_）は、人物リストのオーディエンスを定義する場合や、人物ジャーニーのセグメント化に使用する場合のフィルターとして使用できます。
...
![人物リストの派生ペルソナのフィルタリング &#x200B;](./assets/derived-persona-filter-people-list.png){width="700" zoomable="yes"}
...
![分割パス条件の派生ペルソナ フィルタリング &#x200B;](./assets/derived-persona-filter-split-path.png){width="700" zoomable="yes"}
