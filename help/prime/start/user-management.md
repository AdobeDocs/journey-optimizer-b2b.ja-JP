...
1. [Admin ConsoleでAdobe Journey Optimizer B2B edition製品プロファイル &#x200B;](#ajo-b2b-profile)を作成します（1回限り/初期設定のみ）。
...
## Adobe Journey Optimizer B2B editionの商品プロファイルを作成する {#ajo-b2b-profile}
...
![管理者の役割の要件](../../assets/do-not-localize/icon-admin-user.svg){width="30"} システム管理者またはAdobe Journey Optimizer B2B edition製品管理者は、次の手順を実行できます。
