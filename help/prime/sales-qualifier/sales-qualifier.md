---
title: 販売修飾子
description: Journey Optimizer B2B PrimeのSales Qualifierでは、BDR向けに、AIによる見込み顧客の絞り込み、アウトバウンドワークフロー、CRM統合、タスク、プロファイル設定を提供します。
...
![販売修飾子のホーム画面](../../user/agents/assets/home-screen.png){width="800" zoomable="yes"}
...
リードのステータスと見込み客の管理の最後のアクティビティを表示する![見込み客テーブル ](../../user/agents/assets/prospects.png){width="800" zoomable="yes"}
...
![ アウトバウンドワークフローの概要タブ ](../../user/agents/assets/outbound-workflow-overview.png){width="800" zoomable="yes"}
...
1. 独自の目標を作成するには、**[!UICONTROL 最初から開始]**&#x200B;を選択するか、保存したテンプレートを使用するには、**[!UICONTROL テンプレートから開始]**&#x200B;を選択します。
   ...
   ![送信ワークフローを最初から作成](../../user/agents/assets/outbound-workflow-create-start-from-scratch.png){width="700" zoomable="yes"}
...
1. 下向き矢印をクリックして、**[!UICONTROL フィルターを追加]** リストを表示し、適用するフィルターを選択します。
   ...
   ![ アウトバウンドワークフローのターゲティングフィルターの作成](../../user/agents/assets/outbound-workflow-create-targeting-filter-list.png){width="700" zoomable="yes"}

1. フィルターの値を設定します。

1. オーディエンスを絞り込む必要がある場合は、さらにフィルターを追加します。

   ![値を持つフィルターを追加した送信ワークフローのターゲット設定を作成](../../user/agents/assets/outbound-workflow-create-targeting-filters-values.png){width="600" zoomable="yes"}
...
![ アウトバウンドワークフローがタッチポイントのケイデンスとプロンプトを生成しました](../../user/agents/assets/outbound-workflow-create-touchpoints.png){width="700" zoomable="yes"}
...
![ アウトバウンドワークフロー設定](../../user/agents/assets/outbound-workflow-create-settings.png){width="700" zoomable="yes"}
...
![ アウトバウンドワークフローで見込み客を追加](../../user/agents/assets/outbound-workflow-create-add-prospects.png){width="700" zoomable="yes"}
...
![送信ワークフローのレビューが生成されたメール ](../../user/agents/assets/outbound-workflow-create-review-generated-emails.png){width="700" zoomable="yes"}
...
![ アウトバウンドワークフローが生成したメール AIの推論](../../user/agents/assets/outbound-workflow-create-review-generated-email-reasoning.png){width="600" zoomable="yes"}
...
1. メールエディターで、**[!UICONTROL AIを使用して生成]**&#x200B;をクリックします。
   ...
   ![AIを使用して電子メールの絞り込みを生成したアウトバウンドワークフロー](../../user/agents/assets/outbound-workflow-create-review-generated-email-edit-regenerate.png){width="600" zoomable="yes"}
...
![ アウトバウンドワークフローで見込み客を選択して承認](../../user/agents/assets/outbound-workflow-create-approve-enroll-prospects.png){width="700" zoomable="yes"}
...
タスクキューと詳細パネルを表示する![ タスクページ ](../../user/agents/assets/tasks.png){width="800" zoomable="yes"}
...
1. 左側のナビゲーションで、**[!UICONTROL 管理]**&#x200B;を展開し、**[!UICONTROL 統合]**&#x200B;を選択します。
   ...
   ![SalesforceとDynamicsの連携カードを使用した連携ページ ](../../user/agents/assets/integrations-crm-connections.png){width="800" zoomable="yes"}
...
![統合 – ナレッジセンター](../../user/agents/assets/integrations-knowledge-center.png){width="700" zoomable="yes"}
...
メール接続オプションとメール署名設定を表示する![ メール設定タブ ](../../user/agents/assets/email-settings.png)
