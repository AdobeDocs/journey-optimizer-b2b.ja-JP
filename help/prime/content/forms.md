...
![Forms リストに表示する列](../../user/content/assets/forms-customize-table-dialog.png){width="300"}
...
![公開されたフォームの詳細を表示](../../user/content/assets/form-details-published.png){width="600" zoomable="yes"}
...
![重複するフォームの名前と説明](../../user/content/assets/form-duplicate-dialog.png){width="400"}
...
![選択したフォームにアクションを適用](../../user/content/assets/form-actions-page-authoring.png){width="600" zoomable="yes"}
