...
[!DNL Journey Optimizer B2B Prime]で再利用可能なフォームの作成を開始する前に考慮すべき点がいくつかあります。
...
[!DNL Journey Optimizer B2B Prime]でフォームを作成するには、_[!UICONTROL Forms]_ リストページの右上にある&#x200B;**[!UICONTROL フォームを作成]**&#x200B;をクリックします。
...
* **[!UICONTROL ランディングページ]** - [!DNL Journey Optimizer B2B Prime]のランディングページをフォローアップとして選択するには、このオプションを選択します。
...
右側の&#x200B;_[!UICONTROL 概要]_ パネルで、**[!UICONTROL 使用者]** タブをクリックして、ランディングページとランディングページテンプレートをまたいで、[!DNL Journey Optimizer B2B Prime]内でフォームが現在使用されている場所の詳細を表示します。
