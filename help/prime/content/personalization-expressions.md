...
パーソナライゼーションエディターは、[!DNL Journey Optimizer B2B Prime]のパーソナライゼーションの中核です。 動的なコンテンツが必要な場所（[電子メール ](./email-authoring.md#personalize-content)、[WhatsApp メッセージ ](./whatsapp-authoring.md#personalize-message-content)、[ ランディングページ ](./landing-pages.md)、URL フィールド）で使用できます。
...
電子メールと[WhatsApp メッセージ ](./whatsapp-authoring.md#personalize-message-content)では、パーソナライゼーションは、電子メールの&#x200B;**[!UICONTROL 件名]** フィールドや、承認済みのWhatsApp テンプレートの動的パラメーターなど、様々な場所に追加できます。
