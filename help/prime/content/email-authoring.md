...
[構造コンポーネント ](./structure-components.md)と[ コンテンツコンポーネント ](./content-components.md)をキャンバスに追加して、メールレイアウトを構築します。 左側のパネルの&#x200B;**[!UICONTROL 構造]**&#x200B;および&#x200B;**[!UICONTROL コンテンツ]** セクションから項目をドラッグし、右側の&#x200B;_[!UICONTROL 設定]_&#x200B;および&#x200B;_[!UICONTROL スタイル]_ タブで各コンポーネントを設定します。
