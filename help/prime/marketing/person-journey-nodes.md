...
個人ジャーニーを作成したら、キャンバスのツールを使用してオーディエンスを追加し、ノードを使用してジャーニーを構築します。 ジャーニーキャンバスでは、マルチステップのB2B マーケティングのユースケースを構築できるビジュアルデザインのスペースを提供します。
...
:::
![人物オーディエンスノード ](https://cdn.experienceleague.adobe.com/icons/users.svg)
...
:::
![ アクションノード ](https://cdn.experienceleague.adobe.com/icons/circle-play.svg)
...
:::
![ イベントノード ](https://cdn.experienceleague.adobe.com/icons/puzzle-piece.svg)
...
:::
![待機ノード ](https://cdn.experienceleague.adobe.com/icons/clock.svg)
...
:::
![ パス ノードの分割と結合](https://cdn.experienceleague.adobe.com/icons/code-branch.svg)
...
:::
![次善のパスノード ](https://cdn.experienceleague.adobe.com/icons/lightbulb.svg)
