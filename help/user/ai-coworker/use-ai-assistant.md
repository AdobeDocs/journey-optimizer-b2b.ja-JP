...
Journey Optimizer B2B editionでは、AI アシスタントのチャットインターフェイスを使用して、製品のコンセプトを理解し、製品の機能をすばやく操作して学習し、自社のビジネス環境に関する運用上のインサイトを得ることができます。 Adobe Experience Cloudの様々な製品でも利用できます。
...
運用インサイトの質問では、組織のサンドボックス内のジャーニーオブジェクトについて質問します。 オーディエンス、ジャーニー、ソリューションへの関心、購買グループテンプレートなどの運用上のアーティファクトについて質問することができます。 運用上のインサイトの質問やプロンプトの例には、次のようなものがあります。
...
チャットインターフェイスには、応答の検証と検証に使用できるツールが含まれています。
