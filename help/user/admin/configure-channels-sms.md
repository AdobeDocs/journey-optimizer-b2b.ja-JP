...
1. SMS API 資格情報を設定します。
   ...
   ![Sinch SMS API資格情報の設定](./assets/config-sms-api-sinch.png){width="600" zoomable="yes"}
...
1. SMS API 資格情報を設定します。
   ...
   ![Twilio SMS API資格情報の設定](./assets/config-sms-api-twilio.png){width="600" zoomable="yes"}
...
1. SMS API 資格情報を設定します。
   ...
   ![Infobip SMS API資格情報の設定](./assets/config-sms-api-infobip.png){width="600" zoomable="yes"}
