...
>[!AVAILABILITY]
>
>通信の制限は、[&#x200B; シンプルなアーキテクチャ &#x200B;](../simplified-architecture.md) でプロビジョニングされたJourney Optimizer B2B edition環境で使用できます。 Adobe サポートに問い合わせるか、サポートチケットを開いて、Journey Optimizer B2B editionと 1 つ以上のMarketo Engage インスタンス間の通信制限の共有を有効にします。
...
1. **[!UICONTROL キャッピング量]** を設定します。
   ...
   値を入力するか、右側の&#x200B;_Up_&#x200B;または&#x200B;_Down_&#x200B;矢印をクリックして、値を増減します。
