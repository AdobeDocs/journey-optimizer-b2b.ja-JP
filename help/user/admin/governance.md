...
EU、カリフォルニア、タイ、ブラジル、ニュージーランドなどの地域でデータ主体のデータを保持している[!DNL Journey Optimizer B2B Edition]人のユーザーには、さまざまな規制が適用されます。 このページに記載されている情報は法的アドバイスではなく、適用法の遵守を保証するものではありません。
...
CNILやその他の規制当局がピクセルのトラッキングや関連する問題に関するガイダンスを明確にするため、Adobeはアップデートを監視し、技術能力の変化を通知します。
