...
>[!TIP]
>
>生成AIを活用したAdobe Journey Optimizer B2B editionのAI アシスタントを利用すれば、コンテンツを進化させることができます。 AI アシスタントを利用すれば、電子メール全体やターゲットを絞ったテキストコンテンツを生成し、オーディエンスの共感を呼ぶ画像に対してAI アシスタントのレコメンデーションを得ることで、配信の効果を最適化することができます。 [詳細情報](./ai-assistant-emails.md)
