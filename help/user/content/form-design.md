...
1. _[!UICONTROL フィールド属性を選択]_ ダイアログで、フィールドに使用するユーザープロファイル属性のチェックボックスを選択し、「**[!UICONTROL 選択]**」をクリックします。
   ...
   [XDM ビジネススキーマ &#x200B;](../admin/field-mapping.md#xdm-business-person-attributes) によって、使用可能な属性が決まります。  Journey Optimizer B2B edition インスタンス用に定義されている任意のカスタムフィールドも使用できます。 「検索」テキストボックスを使用して名前でリストをフィルタリングするか、フィルターアイコンをクリックしてスキーマ/データタイプでリストをフィルタリングします。
