...
お客様が特定のリンクをクリックしたときに定義済みの web ページに移動するように設定するには、Journey Optimizer B2B editionでランディングページを作成します。
...
### 保存済みまたはサンプルテンプレートを選択

次の中から選択できます。

* **サンプルテンプレート**. Journey Optimizer B2B edition インターフェイスには、ランディングページデザインの出発点として使用できる、すぐに使用できるランディングページテンプレートのコレクションが用意されています。
...
* _[!UICONTROL ランディングページ]_ リストページで _詳細_ アイコン（**...**）をクリックします ランディングページ名の横にある「**[!UICONTROL 複製]**」を選択します。
...
* _[!UICONTROL ランディングページ]_ リストページで _詳細_ アイコン（**...**）をクリックします ランディングページ名の横にある「**[!UICONTROL 削除]**」を選択します。
