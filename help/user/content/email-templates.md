...
このアクションは、インスタンスで作成されたすべてのメールテンプレートをテーブルとして表示するリストページを開きます。
...
方法を選択して、メールテンプレートデザインを開始します。 次に、ビジュアルデザインスペースを使用して、メールテンプレートコンテンツを[作成します](./email-template-authoring.md)。

### ゼロからデザイン

ビジュアルコンテンツエディターを使用して、メールコンテンツの構造を定義します。 シンプルなドラッグ&amp;ドロップ操作で構造コンポーネントを追加、移動することで、再利用可能なメールコンテンツをすばやくデザインできます。
...
* アクティブなアラート（メールテンプレートのエラーと警告）がある場合は、右上の「**[!UICONTROL アラート]**」をクリックして情報を表示します。
  ...
  これらのアラートは、メール作成にメールテンプレートを使用することを禁止するものではありません。 この情報により、マーケターは、何が機能しないか、配信に使用する前に必要な更新情報を把握できます。
...
このアクションを実行すると、_テンプレートのデザイン_ ページまたはビジュアルコンテンツエディターページ（メールテンプレートの最後に保存されたステータスに基づく）に移動します。 ここから、必要に応じてメールテンプレートコンテンツを編集できます。 編集オプションについて詳しくは、[電子メールテンプレートの作成](#create-an-email-template)を参照してください。
...
1. ビジュアルデザインスペースに&#x200B;_コンテンツを編集_ ページからアクセスします。
   ...
   _メールを作成_ ページで、システムはデフォルトで「_サンプルテンプレート_」タブを選択します。
