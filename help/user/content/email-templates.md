...
高速で改善された設計プロセスを実現するために、スタンドアロンメールテンプレートを作成して、[!DNL Adobe Journey Optimizer B2B Edition] スタンドアカウントジャーニー全体でカスタムコンテンツを再利用できます。 コンテンツ指向のチームメンバーは、テンプレートを使用することで、ジャーニーの外部でメールコンテンツに取り組むことができます。 その後、マーケティング戦略担当者は、これらのスタンドアロンテンプレートをジャーニー内で再利用および調整できます。 例えば、1 人のチームメンバーがコンテンツのみを担当し、アカウントジャーニーにはアクセスできません。 ただし、マーケターがメール通信の出発点として選択できるメールテンプレートを作成し、ジャーニーの要件に応じてカスタマイズすることはできます。
...
![ メールテンプレートライブラリにアクセスし、名前と日付でフィルタリングする ](./assets/templates-list-search-filter.png){width="800" zoomable="yes"}
