...
>[!NOTE]
>
>2025.10 リリースでは、_[!UICONTROL Account Change Data Value]_ アクションは推奨されません。 _[!UICONTROL アカウントプロファイルの更新]_&#x200B;は、[簡素化されたアーキテクチャ ](../simplified-architecture.md).<br/>に対するこのアクションに代わるものです
>
...
>[!NOTE]
>
>Marketo Engage ]_の_[!UICONTROL &#x200B;人のパーティションを変更および&#x200B;_[!UICONTROL スコアを変更]_ アクションは、2025.10 リリースでは廃止され、Journey Optimizer B2B editionの[簡素化アーキテクチャ ](../simplified-architecture.md)では使用できません。<br/>
>
...
このアクションを使用してメールを送信します。 ノードの電子メール ](../content/add-email.md#add-an-email-to-your-journey)を[作成した後、電子メールデザインスペースで電子メールメッセージをデザイン、パーソナライズ、プレビューできます（[電子メールオーサリング ](../content/email-authoring.md)を参照）。 Marketo Engage](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/creating-an-email/create-an-email){target="_blank"}から[電子メールを送信することもできます。 Marketo Engage ワークスペースを選択し、送信するメールを選択します。
