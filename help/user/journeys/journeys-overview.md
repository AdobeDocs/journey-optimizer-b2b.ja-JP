...
* **個人ジャーニー** - Experience Platform Audiencesとデータを使用してリードベースマーケティングを調整します。 ユーザージャーニーがAdobe Campaignに依存することなく、マーケティング業務を自動化できます。これにより、Marketo Engageや/B2C ツールチェーンの回避策を活用し、B2Bのユースケースをサポートできるようになります。
