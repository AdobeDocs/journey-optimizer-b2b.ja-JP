...
* **人物ジャーニー** - （Beta）Experience Platform オーディエンスとデータを使用してリードベースマーケティングを調整します。 個人ジャーニーの場合、マーケティング業務はMarketo Engageに依存せず、Adobe Campaign/B2C ツールチェーンの回避策も提供されないため、B2Bのユースケースをサポートできます。
  ...
  * 関連オブジェクト（アカウント、購買グループ、商談、カスタムオブジェクト）は、オーケストレーションやパーソナライゼーションに使用できません。
...
ジャーニーのステータスは、適用したアクションに基づいて変更される場合があります。 ジャーニーのステータスに基づいて、ヘッダーの右側から特定のアクションを使用できるか、使用できないかを指定します。
...
| _**中止**_ | ジャーニーを中止すると、ジャーニーのステータスが&#x200B;_ライブ_&#x200B;または&#x200B;_新規エントリに対してクローズ済み_&#x200B;に変更されます。 中止したジャーニーは再開できません。 | <li>[複製](#duplicate-journey) <li>[削除](#delete-journey) |
...
>[!IMPORTANT]
>
>ジャーニーが別のジャーニーで使用されている場合、_アカウントを追加_[!UICONTROL &#x200B;ジャーニー&#x200B;]_でアクション_ ノードを実行し、そのジャーニー内のそのアクションを中止します。
...
このアクションはクローン機能に似ていますが、複製したジャーニーに作成したジャーニーコンテンツアセットは含まれません。 ジャーニーの詳細、またはフロー構造とパス構造の単純な&#x200B;_構造_&#x200B;を複製できます。
...
_ライブ_、_新規エントリに対してクローズ_、_中断_、_完了_&#x200B;のステータスで公開されたアカウントジャーニーの場合、ジャーニーマップを開いて、ジャーニーノードのアカウントの進行状況を確認します。 マップ上の各ノードには、そのノードに到達するアカウント数が表示されます。ライブジャーニーの場合は、現在そのノードにいるアカウント数が表示されます。
