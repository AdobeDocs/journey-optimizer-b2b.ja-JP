---
title: アカウントジャーニー
description: アカウントジャーニーの概要と、アカウントジャーニーリストを使用してアカウントジャーニーを管理する方法を説明します。
...
_[!UICONTROL アカウントジャーニー]_ リストページには、次の列が表示されます。
...
| _**ライブ**_ | ジャーニーを公開すると、ジャーニーのステータスがドラフトからライブに変更されます。この状態では、編集できなくなります。 | <li>[ 複製 ](#duplicate-journey)<li>[ 新規エントリをクローズ ](#close-to-new-entries) <li>[ 中止 ](#abort-journey) |
...
| _**終了**_ | ジャーニー内のすべてのアカウントがジャーニーを完了すると、ステータスが _ライブ_ または _クローズ済み_ から _完了_ に変わります。 | <li>[ 複製 ](#duplicate-journey) <li>[削除](#delete-journey) |
...
>[!IMPORTANT]
>
>_アカウントを（その他）ジャーニーに追加_ アクションを使用して _アクションを実行ノードからの別のジャーニーでそのアカウントジャーニーが使用されると_ ジャーニーの中止によって、そのジャーニーでそのアクションがブロックされます。
