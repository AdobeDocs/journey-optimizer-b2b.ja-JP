...
| [!UICONTROL &#x200B; 特別なフィルター &#x200B;] > [!UICONTROL &#x200B; 商談あり &#x200B;] | アカウントがオポチュニティに関連している、または関連していない。 次のオポチュニティ属性の 1 つ以上に対して評価することもできます。 <li>Amount<li>クローズ日<li>説明<li>予測収益<li>会計四半期<li>会計年度<li>予測カテゴリ<li>予測カテゴリ名<li>クローズ済み<li>獲得済み <li>最後のアクティビティの日付 <li>顧客ソース<li>名前 <li>次の手順 <li>Probability<li>Quantity<li>Stage <li>タイプ |
