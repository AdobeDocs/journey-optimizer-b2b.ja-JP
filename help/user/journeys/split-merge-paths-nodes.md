...
| [!UICONTROL 人物の属性] | [人物プロファイル &#x200B;](../admin/field-mapping.md#xdm-business-person-attributes)の属性（以下を含む）: <li>市町村 <li>国 <li>メールアドレス <li>メール無効 <li>メール中断済み <li>名 <li>推測される都道府県 / 地域 <li>役職 <li>姓 <li>携帯電話番号 <li>人物エンゲージメントスコア <li>電話番号 <li>郵便番号 <li>都道府県 |
