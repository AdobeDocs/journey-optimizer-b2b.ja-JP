...
アカウントジャーニーで分割および結合パスノードを使用し、定義した条件に従って人物またはアカウントをセグメント化します。 条件に従ってジャーニーオーディエンスまたはアカウントリストのパスを定義し、各パスと各セグメントのアクションノードおよびイベントノードを定義してから、パスを組み合わせてジャーニーをさらに続行できます。
