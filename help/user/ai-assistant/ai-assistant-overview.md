...
>[!IMPORTANT]
>
>Journey Optimizer B2B editionで AI アシスタントを使用するには、[&#x200B; ユーザーガイドライン &#x200B;](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"} への同意が必要です。 この契約にはパブリックベータ版の契約も含まれているため、ベータ版の容量で展開する際に追加の AI アシスタント機能を使用できます。
...
製品知識とは、Adobe Experience League に関するJourney Optimizer B2B editionのドキュメントに基づく概念とトピックを指します。 製品に関する知識の質問は、次のサブグループでさらに指定できます。

| 製品に関する知識 | 例 |
| --- | --- |
| 先を見越した学習 | <li>購入グループとは何ですか？ <li> 購買グループの役割テンプレートの例を表示しますか？ |
...
| スキーマ | <li>スキーマ数 <li>作成日/変更日 <li>スキーマ – 属性関係 <li>スキーマ – データセットの関係 <li>スキーマ – オーディエンスの関係 <li>プロファイル有効化ステータス <li>名前検索 <li>名前と ID 検索 | <li>監査 <li>作成/変更 <li>作成者 <li>フィールドグループ <li>ID <li>ID 名前空間 <li>ラベル <li>プロファイル数 |
...
| ソリューションの関心 | <li>カウント <li>ステータス <li>ソリューションの関心 – 購入グループテンプレートの関係 <li>名前と ID 検索 | <li>ソリューションの関心：購入グループの関係 |
