...
[!DNL Adobe Journey Optimizer B2B Edition]にアクセスするには、Adobe IDでAdobe Experience Cloudに接続し、[!DNL Journey Optimizer B2B Edition]を選択します。

![Adobe Experience Platform アプリ](./assets/experience-cloud-apps.png){width="800" zoomable="yes"}

Adobe Experience Platform にログインし、Adobe Journey Optimizer B2B Edition アプリを選択すると、ホームページが表示されます。 このページでは、関連リソースへの<!-- refined insights and-->個のクイックアクセスリンクの形式で、Journey Optimizer B2B イニシアチブの現状の概要を示します。
