...
Adobe Journey Optimizer B2B editionは、Adobe Experience Platform上に構築されています。 この実装では、Journey Optimizer B2B editionとMarketo Engageは同じシステムまたは同じデータストア上にありません。 Journey Optimizer B2B editionは、Adobe Experience Platformからデータを受け取ります。 ただし、システムのプロビジョニングと設定には、Marketo Engageの使用権限と、メール配信などのバックエンド機能が引き続き使用されます。
...
* **複数のAdobe Marketo Engage インスタンスを接続：**&#x200B;複数のMarketo Engage環境のデータを管理および統合します。

* **お客様のデータを保護：**&#x200B;お客様の顧客情報を保護するための高度なプライバシー機能とセキュリティ機能。 （_準備中_）

* **拡張性を考慮した設計：**&#x200B;この設定は、継続的な改善と革新をサポートします。
...
<tbody>
<tr>
<td colspan="2"><strong>標準XDM設定</strong>: XDM個人プロファイルとXDM ビジネスアカウントスキーマを設定します。</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="チェックボックス"/></td>
...
<tr>
<td colspan="2"><strong> リレーショナルスキーマ </strong>: リレーショナル XDM フィールドを選択します（アカウント多対一のカスタムオブジェクト）。</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="チェックボックス"/></td>
...
ジャーニーにほかのチャネルを含むマーケティング部門をサポートするには、追加のチャネルを設定します。
