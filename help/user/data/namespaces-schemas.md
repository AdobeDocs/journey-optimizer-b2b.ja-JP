...
>[!AVAILABILITY]
>
>- B2B スキーマが &lbrace; リアルタイム顧客プロファイル [&#128279;](https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/intro/rtcdpb2b-intro/b2b-overview){target="_blank"} に適合するには、&lbrace;0[Adobe Real-Time Customer Data Platform B2B edition](https://experienceleague.adobe.com/ja/docs/experience-platform/profile/home){target="_blank"} へのアクセス権が必要です。
>
