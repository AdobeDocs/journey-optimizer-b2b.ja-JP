...
| タイプ | 項目 | 説明 |
| ---- | ---- | ----------- |
| 機能強化 | パス ジャーニーノードの分割 – バリアント | マーケターは、定義された割合にもとづいて、アカウントやメンバーを異なるジャーニーパスに割り当てることで、ジャーニー内のバリエーションをテストできるようになりました。 |
| 機能強化 | 外部スプリットパスジャーニーノード – 人物ジャーニー | 外部スプリットパスジャーニーノードのサポートが、個人ジャーニーで利用できるようになりました。 |
| 機能強化 | 外部アクションジャーニーノード – 人物ジャーニー | 外部アクションジャーニーノードのサポートが、個人ジャーニーで利用できるようになりました。 |
