...
| 機能 | エクスペリエンスイベント履歴のフィルタリング | この機能により、B2B ジャーニーオーケストレーションでは、過去のエンゲージメントを利用して、オーディエンスメンバーの行動に基づく意思決定を促進することができます。 |
| 機能 | ジャーニー分割パス決定 | アカウントおよび個人のジャーニーに対して分割パス決定を最適化し、ジャーニーをアクティブ化する前や実行時に、パスをまたいでオーディエンスがどのようにルーティングされるかを調整できます。 |
| 機能強化 | Audience Agentのスキル | AIを活用した購買グループテンプレートの作成など、Audience Agentのスキルが更新されます。 ファーストパーティのインテントとペルソナのマッピングを使用して、購買グループのテンプレートを生成し、AIが推奨する役割とペルソナのマッピングを確認し、公開する前に自然言語でテンプレートを改善します。 |
...
| 機能強化 | 人物ジャーニーの概要ダッシュボード | このダッシュボードでは、アクティブな人物のジャーニーを包括的に把握できます。 |
