...
| タイプ | 項目 | 説明 |
| ---- | ---- | ----------- |
| 機能 | パス ジャーニーノードの分割 – バリアント | （Beta） マーケターは、定義された割合に基づいて、アカウントまたは人物を異なるジャーニーパスに割り当てることで、ジャーニー内のバリエーションをテストできるようになりました。 [詳細情報](../journeys/variant-split-paths-nodes.md) |
