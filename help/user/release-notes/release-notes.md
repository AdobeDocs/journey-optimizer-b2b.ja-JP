...
| タイプ | 項目 | 説明 |
| ---- | ---- | ----------- |
| 機能 | XDM フィールド/リレーショナルスキーマ – 人物カスタムオブジェクトのサポート | 管理者は、アカウントとの単一レベルの一対一の関係を使用して、人物に関連するカスタムオブジェクトを選択できるようになりました。 この機能を使用すると、マーケティング組織は、実際のビジネスデータをより詳細に把握し、人物レベルやアカウントレベルを超えて、エンティティのターゲット、パーソナライズ、レポートを行うことができます。 |
...
| 機能強化 | アカウントおよび人物のジャーニー – 人物カスタムオブジェクトのサポート | アカウントまたはユーザージャーニー内のユーザーをフィルタリングするには、アカウントにリンクされたリレーショナルデータを活用します。 |
| 機能強化 | コンテンツのパーソナライゼーション – 人物カスタムオブジェクトのサポート | カスタムオブジェクトを使用してコンテンツのパーソナライゼーションを定義する場合、モデルベースのクラスのカスタムオブジェクト（リレーショナルスキーマ）の変数にアクセスできます。 |
