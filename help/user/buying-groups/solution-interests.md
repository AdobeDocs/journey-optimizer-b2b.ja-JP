...
省略記号（...）をクリックして、購入グループジョブを削除できます ジョブ名の横にある「**[!UICONTROL 削除]**」を選択します。
...
1. 「**[!UICONTROL 既存の購買グループの更新]**」設定を有効にします（オプション）。
   ...
   このオプションを有効にすると、ソリューションの関心とペアになっているすべての既存の購入グループが、日次同期サイクルを通じて更新されます。
...
1. _[!UICONTROL ソリューションの関心]_ タブから、次のいずれかの方法を使用して、編集するソリューションの関心のプロパティを開きます。
   ...
   * 省略記号（**...**）をクリックします その横にある「編集 **[!UICONTROL を選択し]** す。
...
1. _[!UICONTROL ソリューションの関心]_ タブで、省略記号（**...**）をクリックします ソリューションの関心の横にある「**[!UICONTROL 削除]**」を選択します。
