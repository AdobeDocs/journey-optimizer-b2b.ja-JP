---
title: デフォルトロールとカスタムロール
description: 購買グループのデフォルトの役割を表示して、カスタム役割を作成する – Journey Optimizer B2B editionでビジネスの役割の定義を編集、削除、設定します。
...
1. _[!UICONTROL 購買グループ]_ ページで、「**[!UICONTROL 役割]**」タブを選択します。
   ...
   ![役割タブ &#x200B;](./assets/roles-tab.png){width="700" zoomable="yes"}
...
![&#x200B; カスタムの役割を編集または削除](./assets/roles-more-menu.png){width="600"}
