...
>**機能の非推奨化**</br></br>
>
>Journey Optimizer B2B editionでは、購買グループフィルターは、接続されたMarketo Engage インスタンスでは使用できなくなりました。</br></br>
>
...
マーケターは、Journey Optimizer B2B editionの購買グループに属する人を対象に、Marketo Engageのキャンペーンを抑制することをお勧めします。 また、購買グループに関連するリードに関する情報を利用して、Marketo Engageのリードスコアリングワークフローに情報を提供することもできます。 例：
