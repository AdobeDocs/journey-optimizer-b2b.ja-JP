...
ユーザーエンゲージメントスコアは、[ 役割テンプレート ](./buying-groups-role-templates.md#add-the-template-roles) および [ ジャーニーの人物によるパスのノード ](../journeys/split-merge-paths-nodes.md#people-path-conditions) でのフィルタリングに使用できる属性です。
